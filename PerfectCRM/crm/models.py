...
class Customer(models.Model):
    '''客户信息表'''
    name = models.CharField(max_length=32,blank=True,null=True,unique=True,help_text="用户报名后，改为真实姓名")
...
class Menu(models.Model):
    '''菜单'''
    name = models.CharField(max_length=32)#存别名
    url_type_choise=((0,"alies"),(1,"absoulte"))
    url_type=models.SmallIntegerField(choices=url_type_choise,default=0)
